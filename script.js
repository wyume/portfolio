...
document.querySelector('.modal-box').classList.add('glass');
  ...
  var _di=[{p:'百威 ABI',t:'Mobile / TV',im:['images/budweiser-logo.png']},{p:'永辉超市',t:'PC',im:['images/yonghui-logo.png']},{p:'达能水业',t:'Mobile',im:['images/danone-logo.png']},{p:'日本罗森',t:'PC',im:['images/lawson-logo.png']},{p:'M-Box',t:'TV',im:['images/美的.png']}];
