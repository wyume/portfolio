...
(function () {
  ...
  var productData = {
    ...
    gjfz: {
      ...
      metrics: ['覆盖用户 3 亿+', '案件采集 ≤20 分钟', '全国多省市落地'],
    ...
    qmfz: {
      ...
      metrics: ['北京地区专属', '7 大核心功能', '预警触达率 90%+'], desc: '为夯实首都反诈防线，建设平安首都的治理格局，与北京市公安局联合打造，面向北京地区群众的专属反诈防护工具，以诈骗预警、一键上报、到所报案、身份验真、号码标注、群组反诈等多项实用功能，全方位提升全民防诈、识诈、反诈能力。',
      imgs: ['images/qmfz-01.png', 'images/qmfz-02.png']
    },
    sjgf: {
      name: '省级国反分布式系统', cat: '反电信网络诈骗类', logo: 'images/gjfz-logo.png',
      metrics: ['5+ 省交付', '标准化方案模板', '部地数据协同'], desc: '以"国家反诈中心App"为基座，为各省市公安机关构建并落地标准化、定制化的本地化反诈方案与反诈服务平台，赋能地方公安对反诈数据、能力的充分应用与拓展延伸。',
      imgs: ['images/sjgf-01.png', 'images/sjgf-02.png', 'images/sjgf-03.png', 'images/sjgf-04.png']
    },
    jingyin: {
      name: '警音小程序', cat: '反电信网络诈骗类',
      metrics: ['公安内部通讯', '实时语音告警', '多端同步'], desc: '公安内部语音预警与通讯产品，提供实时语音告警、警情播报、调度通讯等功能。',
      outputs: [
    ...
    zsliam: {
      ...
      metrics: ['国家级版权联盟链', '接入 3+ 文创平台', '全链路闭环'], desc: '基于区块链的数字版权登记、交易与流转平台，提供版权存证、智能合约交易、版权溯源等核心能力。',
      outputs: [
    ...
    guoban: {
      ...
      metrics: ['数字资产发行', '二级市场', '智能分账'], desc: '国家级数字版权创新平台，聚焦版权资产的数字化发行与交易流转。',
      outputs: [
    ...
    'zsl-browser': {
      ...
      metrics: ['链上可视化', '合约验证', '实时追踪'], desc: '区块链浏览器产品，支持交易查询、区块浏览、地址监控、智能合约验证等功能。',
      outputs: [
    ...
    bitker: {
      ...
      metrics: ['多币种支持', '全球多语言', '现货+合约交易'], desc: '全球化的数字资产交易平台，支持多币种交易、法币兑换、资产管理等功能。',
      outputs: [
    ...
    hudaiwang: {
      ...
      metrics: ['资金存管银行对接', '年均交易额 10 亿+', '用户 50 万+'], desc: '聚焦普惠金融领域，依托线下真实借贷资产，提供多元化理财及债权转让服务，实现资金撮合、资产匹配与本息回款全流程线上化运营。',
      outputs: [
    ...
    gnxd: {
      ...
      metrics: ['多机构聚合', '智能产品匹配', '合规流程'], desc: '金融信息服务平台，聚合银行/消金/小贷机构资源，提供个人信贷撮合与智能匹配服务。',
      outputs: [
    ...
    gwxd: {
      ...
      metrics: ['授信风控', '产品矩阵', '会员权益'], desc: '面向个人用户的助贷撮合服务，提供授信评估、产品匹配、会员权益等核心功能。',
      outputs: [
    ...
    popcash: {
      ...
      metrics: ['海外本地化', '全流程管理', '已上线试运行'], desc: '面向印度及海外市场的小额信贷产品线，涵盖"贷前-贷中-贷后"全流程管理，已上线试运行。',
      outputs: [
    ...
    // 金融支付类
    quanzhanye: {
      name: '全民展业 App', cat: '金融支付类',
      metrics: ['银行卡收单', '实时查询', '业绩看板'], desc: '面向商户的展业工具，支持银行卡收单、商户管理、交易查询、业绩统计等功能。',
      outputs: [
    ...
    weifenxiao: {
      ...
      metrics: ['多级分销', '自动结算', '团队管理'], desc: '面向商户的分销管理平台，支持多级分销、佣金结算、团队管理等功能。',
      outputs: [
    ...
    xinshengdai: {
      ...
      metrics: ['智能还款', '多卡管理', '实时计费'], desc: '信用卡代还服务平台，提供智能还款计划、费率计算、账单管理等金融工具。',
      outputs: [
    ...
    qianbaoxiaodai: {
      ...
      metrics: ['快速授信', '灵活分期', '全程风控'], desc: '小额信贷产品，面向个人用户提供快速借款、分期还款等金融服务。',
      outputs: [
    ...
    panda: {
      ...
      metrics: ['社交裂变', '二级分销', '社群运营'], desc: '社交电商买手平台，结合社交裂变与电商交易，提供商品推荐、佣金分润、社群运营等功能。',
      outputs: [
    ...
    octopus: {
      ...
      metrics: ['多平台聚合', '智能定价', '一键分发'], desc: '多源商品聚合与分销平台，支持商品采集、智能定价、多渠道分发、订单管理等核心能力。',
      outputs: [
    ...
    feiyu: {
      ...
      metrics: ['合伙人模式', '分销裂变', '佣金激励'], desc: '社交电商合伙人平台，以合伙人/代理商模式为核心，支持多级分销、团队管理、佣金结算与裂变增长。',
      outputs: [
    ...
    maishou: {
      ...
      metrics: ['商户入驻', '商品管理', '订单履约'], desc: '面向 B 端商户的 SaaS 管理平台，支持店铺开通、商品上架、订单处理、结算对账等商户日常运营需求。',
      outputs: [
...
document.querySelector('.modal-box').classList.add('glass');
  ...
  function _buildSlnLightbox(k,files){
    var idx=0;
    var lb=document.createElement('div');lb.className='doc-lb-overlay';
    var bar=document.createElement('div');bar.className='doc-lb-bar';
    var barL=document.createElement('div');barL.className='doc-lb-bar-left';
